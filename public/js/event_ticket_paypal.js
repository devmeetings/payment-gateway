                        ...
                        <div className='checkbox'>
                            <label>
                                <input type='checkbox' name={this.props.name}
                                       onChange={this.props.onChange}/> {T.invoice.wantToReceiveInvoice}
                            </label>
                        </div>
                    </div>
                </div>
        ...
        render: function () {
            ...
            return (
                <fieldset className={componentClass}>
                    ...
                    <InputField name='street' title={T.invoice.street} placeholder={T.invoice.street}
                                disabled={disabled}/>
                    <InputField name='postalCode' title={T.invoice.postalCode} placeholder={T.invoice.postalCode}
                                disabled={disabled}/>
            ...
            return (
                <div>
                    ...
                    <div className='well'>
                        ...
                        <hr/>
                        <form id="checkout-form" method='post' className='form-horizontal clearfix'>
                            <fieldset>
                                <h4>{T.contactData}</h4>
                            ...
                            <fieldset>
                                ...
                                <div className='form-group'>
                                    ...
                                    <div className='col-md-9'>
                                        ...
                                        <RadioField name='payment' value='75' type='radio-danger'
                                                    onChange={this.changeValue}>
                                            <span>75 {claim.currency}</span>
                                        </RadioField>
                                        <RadioField name='payment' value='100' type='' checked
                                                    onChange={this.changeValue}>
                                            <span>100 {claim.currency} {T.payment.diplomaInfo}</span>
                                        </RadioField>
                                        <RadioField name='payment' value='150' type='radio-success'
                                                    onChange={this.changeValue}>
                                            <span>150 {claim.currency}</span>
                                        </RadioField>
                                        <RadioField name='payment' value='200' type='radio-success'
                                                    onChange={this.changeValue}>
                            ...
                            <div id="paypal-btn" className='pull-right'>
                            </div>
                        </form>
                    </div>
                </div>
